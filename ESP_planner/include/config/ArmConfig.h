...
// 右机械臂舵机 ID
// ============================================================
constexpr uint8_t RIGHT_BASE_ID     = 5;   // 右臂底座旋转
constexpr uint8_t RIGHT_SHOULDER_ID = 6;   // 右臂肩关节
constexpr uint8_t RIGHT_ELBOW_ID    = 7;   // 右臂肘关节
constexpr uint8_t RIGHT_GRIPPER_ID  = 8;   // 右臂夹爪

// ============================================================
// 舵机参数限制
// ============================================================
constexpr uint16_t SERVO_PWM_MIN = 500;    // PWM 最小值
...
// 机械臂舵机总数
// ============================================================
constexpr uint8_t TOTAL_SERVO_COUNT = 8;
